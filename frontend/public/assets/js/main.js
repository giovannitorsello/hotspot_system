...
if (document.querySelector(".burger-btn"))
  document.querySelector(".burger-btn").addEventListener("click", () => {
    if (document.getElementById("sidebar")) document.getElementById("sidebar").classList.toggle("active");
  });
...
if (document.querySelector(".sidebar-item.active")) document.querySelector(".sidebar-item.active").scrollIntoView(false);
