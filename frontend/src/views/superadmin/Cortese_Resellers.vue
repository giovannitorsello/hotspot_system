                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">INSERISCI RESELLER</h4>
                      </div>
...
<script>
  ...
  import TableReseller from "@/components/superadmin/Cortese_TableResellerSuperadmin.vue";
  import axios from "axios";
  export default {
    name: "Reseller",
    components: { SidebarSuperadmin, TableReseller, FormReseller },
    setup() {
