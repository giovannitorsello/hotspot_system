<template>
    <div>
        <v-row>
            <v-col cols="auto">
                <v-btn icon="fas fa-plus" @click="addWebsurfer" /> </v-col>
        </v-row>
        <v-row>
...
import SnackbarMessageVue from '@/components/general/SnackbarMessage.vue';
export default {
    name: "TableWebsurfer",
    setup() {
    ...
    components: { FormWebsurfer, TableTicket, SnackbarMessageVue },
    data() {
        return {
