<template>
    <v-row class="justify-content-center">
        <v-col cols="auto">
            <v-btn icon="bi bi-plus" @click="addCustomer" /> </v-col>
    </v-row>
    <v-row>
        <v-text-field v-model="search" label="Cerca"></v-text-field>
        <v-data-table :headers="headers" :items="hsComponentStore.customersOfSelectedReseller" :search="search" :page.sync="page" :items-per-page="itemsPerPage" :hide-default-footer="true" disable-pagination>
