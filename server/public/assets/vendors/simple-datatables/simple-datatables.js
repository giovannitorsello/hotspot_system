                    ...
                    var dayjs_min = createCommonjsModule(function (t, n) {
                            t.exports = function () {
                                ...
                                var v = function () {
                                    ...
                                    d.startOf = function (t, a) {
                                        ...
                                        switch (c) {
                                            case u: return f ? d(1, 0) : d(31, 11);
                                            case o: return f ? d(1, $) : d(0, $ + 1);
                                            case s: var y = this.$locale().weekStart || 0,
                                                    v = (m < y ? m + 7 : m) - y;
                                                return d(f ? M - v : M + (6 - v), $);
                                            case i:
                                            case "date":
                                                return l(D + "Hours", 0);
                                            case r: return l(D + "Minutes", 1);
                                            case e: return l(D + "Seconds", 2);
                                            case n: return l(D + "Milliseconds", 3);
                                            default:
                                                return this.clone()
                                        }
                                    },
                                    ...
                                    d.$set = function (s, a) {
                                        var h,
                                            ...
                                            d = (h =
                                                {}, h[i] = c + "Date", h.date = c + "Date", h[o] = c + "Month", h[u] = c + "FullYear", h[r] = c + "Hours", h[e] = c + "Minutes", h[n] = c + "Seconds", h[t] = c + "Milliseconds", h)[f],
                                    ...
                                    d.add = function (t, a) {
                                        ...
                                        var l = (h =
                                                {}, h[e] = 6e4, h[r] = 36e5, h[n] = 1e3, h)[c] || 1,
                                            m = this.valueOf() + t * l;
                                        return g.w(m, this)
                                    },
                                    ...
                                    d.diff = function (t, h, f) {
                                        var c,
                                            ...
                                            M = g.m(this, l);
                                        return M = (c =
                                            {}, c[u] = M / 12, c[o] = M, c[a] = M / 3, c[s] =( $ - m) / 6048e5, c[i] =( $ - m) / 864e5, c[r] = $ / 36e5, c[e] = $ / 6e4, c[n] = $ / 1e3, c)[d] || $,
                                        f ? M : g.a(M)
                                    },
                        ...
                        customParseFormat = createCommonjsModule(function (t, n) {
                            var e,
                                ...
                                h,
                                f;
                            t.exports = (r =/(\[[^[]*\])|([-:\/.()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, o =/\d*[^\s\d-:\/.()]+/, u =[
                                /[+-]\d\d:?\d\d/, function (t) {
                                    var n,
                                        e;
                                    (this.zone || (this.zone =
                                        {})).offset = (n = t.match(/([+-]|\d\d)/g), 0 == (e = 60 * n[1] + + n[2]) ? 0 : "+" === n[0] ? - e : e)
                                }
                            ], h =
                                {
                                A: [
                            ...
                            function (t, n, r) {
                                ...
                                i.parse = function (t) {
                                    var n = t.date,
                                        ...
                                        a = t.utc;
                                    this.$u = a,
                                    i ? (e = o ? r.Ls[o] : this.$locale(), this.$d = f(n, i, a), this.init(t)) : s.call(this, t)
                                }
                            })
                        });
                    ...
                    const parseDate = (t, n) => {
                        ...
                        if (n) 
                            switch (n) {
                                case "ISO_8601": e = t;
                                    break;
                                case "RFC_2822": e = dayjs_min(t, "ddd, MM MMM YYYY HH:mm:ss ZZ").format("YYYYMMDD");
                                    break;
                                case "MYSQL": e = dayjs_min(t, "YYYY-MM-DD hh:mm:ss").format("YYYYMMDD");
                                    break;
                                case "UNIX": e = dayjs_min(t).unix();
                                    break;
                                default: e = dayjs_min(t, n).format("YYYYMMDD")
                            }
            ...
            function (require, module, exports) {
                ...
                class Columns {
                    ...
                    order(t) {
                        ...
                        o.data.forEach((e, s) => {
                            ...
                            t.forEach(t => {
                                ...
                                a.appendChild(r),
                                o.hiddenColumns.includes(t) || ((r = e.cells[t].cloneNode(!0)).data = e.cells[t].data, i.appendChild(r))
                            }),
                            h[2].push(a),
                            h[3].push(i)
                        }),
                    ...
                    visible(t) {
                        ...
                        isNaN(t) ? Array.isArray(t) && (e =[], t.forEach(t => {
                    ...
                    rebuild() {
                        ...
                        i.data.forEach((l, r) => {
                            ...
                            Array.from(l.cells).forEach(n => {
                                ...
                                t.appendChild(s),
                                i.hiddenColumns.includes(s.cellIndex) || ((a = s.cloneNode(!0)).data = s.data, e.appendChild(a))
                            }),
                            n.push(t),
                            i.activeRows.push(e)
                        }),
                ...
                class DataTable {
                    ...
                    render(t) {
                        ...
                        if (e.searchable) {
                            const t = `<div class='dataTable-search'><input class='dataTable-input' placeholder='${
                                e.labels.placeholder
                            }' type='text'></div>`;
                    ...
                    paginate() {
                        ...
                        return this.searching && (e =[], this.searchData.forEach(t => e.push(this.activeRows[t]))),
                        ...
                        if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                            ...
                            if (this.columnWidths =[], this.table.tHead) {
                                if (this.options.scrollY.length && ((e = createElement("thead")).appendChild(createElement("tr")), e.style.height = "0px", this.headerTable && (this.table.tHead = this.headerTable.tHead)), this.activeHeadings.forEach(t => {
                                    ...
                                    if (t.style.width =
                                        `${i}%`, this.columnWidths[s] = a, this.options.scrollY.length) {
                                    ...
                                    this.headerTable.parentElement.style.paddingRight = `${
                                        this.headerTable.clientWidth - this.table.clientWidth + parseInt(this.headerTable.parentElement.style.paddingRight || "0", 10)
                                    }px`,
                                ...
                                this.data.forEach(t => {
                                    Array.from(t.cells).forEach((t, e) => {
                                        this.columns(t.cellIndex).visible() && (t.style.width =
                                            `${ a[e]
                                        }%`)
                                    })
                                }),
                    ...
                    fixHeight() {
                        this.options.fixedHeight && (this.container.style.height = null, this.rect = this.container.getBoundingClientRect(), this.container.style.height =
                            `${ this.rect.height
                        }px`)
                    }
                    search(t) {
                        ...
                        if (h.type) {
                            ...
                            if (s.length) {
                                if ("txt" === h.type || "csv" === h.type) {
                                    ...
                                    l = l.trim().substring(0, l.length - 1),
                                    h.download && (l =
                                        `data:text/csv;charset=utf-8,${l}`)
                                } else if ("sql" === h.type) {
                                    for (l =
                                        `INSERT INTO \`${ h.tableName
                                    }\` (`, i = 0; i < e.length; i++) 
                                        ! h.skipColumn.includes(e[i].originalCellIndex) && this.columns(e[i].originalCellIndex).visible() && (l +=
                                            `\`${ e[i].textContent
                                        }\`,`);
                                    
                                    for (l = l.trim().substring(0, l.length - 1), l += ") VALUES ", i = 0; i < s.length; i++) {
                                        for (l += "(", n = 0; n < s[i].cells.length; n++) 
                                            ! h.skipColumn.includes(e[n].originalCellIndex) && this.columns(e[n].originalCellIndex).visible() && (l +=
                                                `"${ s[i].cells[n].textContent
                                            }",`);
                                    ...
                                    l += ";",
                                    h.download && (l =
                                        `data:application/sql;charset=utf-8,${l}`)
                                } else if ("json" === h.type) {
                                    ...
                                    h.download && (l =
                                        `data:application/json;charset=utf-8,${l}`)
                                }
                                return h.download && (h.filename = h.filename || "datatable_export", h.filename +=
                                    `.${ h.type
                                }`, l = encodeURI(l), (r = document.createElement("a")).href = l, r.download = h.filename, document.body.appendChild(r), r.click(), document.body.removeChild(r)),
                                l
                            }
                        }
                        return !1
