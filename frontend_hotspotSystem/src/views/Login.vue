...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="index.html"><img src="src/img/logo_ASYTECH.png" alt="Logo"></a>
            </div>
...
export default {
  ...
  methods: {
    checkCredentials(){
        axios.post('http://localhost:80/admin/login',{username: this.username, password: this.password}).then((response) =>{
